...
import { FaRocket, FaBuilding, FaMountain, FaTimes } from "react-icons/fa";
  ...
  const valeurs: ValueItem[] = [
    {
      ...
      description:
        "Nous nous engageons à révéler le potentiel unique de chaque enfant en difficulté. Notre mission : les accompagner avec détermination vers l'autonomie et l'épanouissement, sans compromis.",
      color: {
    ...
    },
    {
      ...
      description:
        "Création des sites internet, création des plateformes de streaming, lancement de boutique en présentiel, lancement des projets agricoles.",
      color: {
  ...
  return (
    <section className="mx-auto min-h-screen bg-gradient-to-br from-gray-950 to-black py-16 px-4 sm:px-6 lg:px-8">
      <div className="mb-16 text-center">
        ...
        >
          Nos <span className="text-gray-300 font-extrabold">projets</span>
        </motion.h2>
      ...
      >
        {valeurs.map((valeur) => (
          ...
          >
            <div
              className={`relative flex h-80 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-t shadow-xl transition-all duration-300 ${valeur.color.from} ${valeur.color.to}`}
              onClick={() =>
