...
const images = [
  {
    url: "https://img.freepik.com/photos-premium/sac-dos-scolaire-papeterie-scolaire-fond-colore-concept-retour-ecole_488220-18225.jpg?uid=R200764655&ga=GA1.1.897716781.1747638220&semt=ais_hybrid&w=740",
    alt: "Soins longue durée",
  },
  {
    url: "https://img.freepik.com/photos-gratuite/groupe-enfants-africains-pretant-attention-classe_23-2148892518.jpg?uid=R200764655&ga=GA1.1.897716781.1747638220&semt=ais_hybrid&w=740",
    alt: "Aide à domicile",
  },
  {
    url: "https://img.freepik.com/photos-premium/ecolier-selection-livre-bibliotheque-bibliotheque_107420-40617.jpg?uid=R200764655&ga=GA1.1.897716781.1747638220&semt=ais_hybrid&w=740",
    alt: "Maison de retraite",
  },
];

export default function AideEducative() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 py-16 sm:py-20 bg-gradient-to-br from-gray-950 to-black text-white text-center overflow-hidden">
      ...
      <motion.p
        ...
        initial="hidden"
        animate="visible"
        className="text-center md:text-justify max-w-4xl md:max-w-5xl lg:max-w-6xl text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 sm:mb-12 px-4 leading-relaxed sm:leading-loose"
      >
