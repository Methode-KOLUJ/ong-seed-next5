...
export default function NosValeurs() {
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 mx-auto min-h-screen bg-gradient-to-br from-gray-950 to-black">
      ...
      <div className="mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
        {valeurs.map((valeur) => (
          <motion.div
            key={valeur.id}
          ...
          >
            <div
              className={`relative h-95 rounded-2xl overflow-hidden shadow-xl cursor-pointer transition-all duration-300 ${hoveredValue === valeur.id ? "shadow-2xl" : ""}`}
