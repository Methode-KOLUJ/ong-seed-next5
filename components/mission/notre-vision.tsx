    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 mx-auto min-h-screen bg-gradient-to-br from-gray-950 to-black">
      ...
      >
        {valeurs.map((valeur) => (
          ...
          >
            <div
              className={`relative h-90 rounded-2xl overflow-hidden shadow-xl cursor-pointer transition-all duration-300 bg-gradient-to-t ${valeur.color} flex flex-col items-center justify-center`}
