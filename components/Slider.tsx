...
const slides: Slide[] = [
  {
    ...
    description: "Nous avons des chaînes grâce auxquelles nous diffusons nos différents contenus.",
  ...
  },
  {
    ...
    gradient: "from-gray-900/50 to-transparent",
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="container h-full flex items-center relative z-10 lg:p-12">
        ...
        >
          <h1 
            className="text-4xl md:text-5xl lg:text-6xl xl:text-8xl font-extrabold mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-300"
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl mb-8 text-white font-semibold"
